# A tool by nitro from OSᗩᗰᗩ-ZᗩᗰZᗩᗰ
...
echo " " 
echo -e "$red                       ▶Coded by$grn NITRO$red◀$rset"
echo -e "$red                      ⫸$ylo  OSAMA Hackers$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
echo " "
...
echo -e "\e[93m             IAM FROM \e[92mOSAMA HACKERS" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92m OSAMA-ZAMZAM\e[0m" | pv -qL 10
